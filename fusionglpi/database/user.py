...
class User(db.Model):
    ...
    dropdown_chars_limit = db.Column(db.Integer, nullable=False,
                                     server_default="0")
    use_flat_dropdowntree = db.Column(db.Boolean, nullable=False,
                                      server_default="0")
    show_jobs_at_login = db.Column(db.Boolean, nullable=False,
                                   server_default="0")
    ...
    followup_private = db.Column(db.Boolean, nullable=False,
                                 server_default="0")
    task_private = db.Column(db.Boolean, nullable=False, server_default="0")
    default_requesttype_id = db.Column(db.Integer, nullable=False,
                                       server_default="0")
    ...
    show_count_on_tabs = db.Column(db.Boolean, nullable=False,
                                   server_default="0")
    refresh_ticket_list = db.Column(db.Integer, nullable=False,
                                    server_default="0")
    set_default_tech = db.Column(db.Boolean, nullable=False,
                                 server_default="0")
    personal_token = db.Column(db.String(255, None, True))
    personal_token_date = db.Column(db.DateTime)
    display_count_on_home = db.Column(db.Integer, nullable=False,
                                      server_default="0")
    notification_to_myself = db.Column(db.Boolean, nullable=False,
                                       server_default="0")
    ...
    duedatewarning_less = db.Column(db.Integer, nullable=False,
                                    server_default="0")
    duedatecritical_less = db.Column(db.Integer, nullable=False,
                                     server_default="0")
    ...
    keep_devices_when_purging_item = db.Column(db.Boolean, nullable=False,
                                               server_default="0")
