...
class NetworkportWifi(db.Model):
    ...
    device_networkcard_id = db.Column(db.Integer,
                                      db.ForeignKey('device_networkcard.id'))
    wifinetwork_id = db.Column(db.Integer, db.ForeignKey('wifinetwork.id'))
    networkport_wifi_id = db.Column(db.Integer,
                                    db.ForeignKey('networkport_wifi.id'))
