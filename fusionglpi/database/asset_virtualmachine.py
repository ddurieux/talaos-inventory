...
class AssetVirtualmachine(db.Model):
    ...
    virtualmachine_state_id = db.Column(db.Integer, db.ForeignKey('virtualmachine_state.id'))
    virtualmachine_system_id = db.Column(db.Integer, db.ForeignKey('virtualmachine_system.id'))
    virtualmachine_type_id = db.Column(db.Integer, db.ForeignKey('virtualmachine_type.id'))
