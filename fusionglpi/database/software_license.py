...
class SoftwareLicense(db.Model):
    ...
    software_license_type_id = db.Column(
        db.Integer,
        db.ForeignKey('software_license_type.id'))
    ...
    software_version_buy_id = db.Column(
        db.Integer,
        db.ForeignKey('software_version.id'))
    software_version_use_id = db.Column(
        db.Integer,
        db.ForeignKey('software_version.id'))
