...
class Entity(db.Model):
    ...
    cartridges_alert_repeat = db.Column(db.Integer, nullable=False,
                                        server_default="0")
    consumables_alert_repeat = db.Column(db.Integer, nullable=False,
                                         server_default="0")
    use_licenses_alert = db.Column(db.Integer, nullable=False,
                                   server_default="0")
    send_licenses_alert_before_delay = db.Column(db.Integer, nullable=False,
                                                 server_default="0")
    use_contracts_alert = db.Column(db.Integer, nullable=False,
                                    server_default="0")
    send_contracts_alert_before_delay = db.Column(db.Integer, nullable=False,
                                                  server_default="0")
    use_infocoms_alert = db.Column(db.Integer, nullable=False,
                                   server_default="0")
    send_infocoms_alert_before_delay = db.Column(db.Integer, nullable=False,
                                                 server_default="0")
    use_reservations_alert = db.Column(db.Integer, nullable=False,
                                       server_default="0")
    ...
    auto_assign_mode = db.Column(db.Integer, nullable=False,
                                 server_default="0")
    ...
    # ticket_template_id = db.Column(db.Integer, nullable=False,
    #                                server_default="0")
    entity_id_software = db.Column(db.Integer, nullable=False,
                                   server_default="0")
    default_contract_alert = db.Column(db.Integer, nullable=False,
                                       server_default="0")
    default_infocom_alert = db.Column(db.Integer, nullable=False,
                                      server_default="0")
    default_cartridges_alarm_threshold = db.Column(db.Integer, nullable=False,
                                                   server_default="0")
    default_consumables_alarm_threshold = db.Column(db.Integer, nullable=False,
                                                    server_default="0")
    delay_send_emails = db.Column(db.Integer, nullable=False,
                                  server_default="0")
